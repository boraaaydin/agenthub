...
export default async function ProjectWorkitemsPage(props: PageProps<"/projects/[id]/workitems">) {
  ...
  try {
    ...
    console.error("Unable to validate project before redirecting to workitems", error);
  ...
  redirect(`/workitems?${target.toString()}`);
}
